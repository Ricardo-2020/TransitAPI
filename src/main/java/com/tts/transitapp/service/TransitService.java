...
public class TransitService {
    ...
    public List<Bus> getNearbyBuses(BusRequest request){
        ...
        // getting buses then setting up person location
        // setting up emppty array list to fill with buses
        ...
        // got through each of the buses
        // set up there location and then get there lat & lat(current location)
        // 
